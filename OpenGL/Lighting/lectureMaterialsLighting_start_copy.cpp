...
void initLighting() {
    if (strcmp(OPTION, "0") == 0) {
    ...
    else if (strcmp(OPTION, "2.dlur") == 0) {
        printf("OPTION: %s\n", OPTION);
        glEnable(GL_LIGHTING);
        // set up light colors (ambient, diffuse, specular)
        GLfloat lightKa[] = {0.8f, 0.8f, 0.8f, 1.0f};   // ambient light
    ...
    else if (strcmp(OPTION, "2.urdl") == 0) {
        printf("OPTION: %s\n", OPTION);
        glEnable(GL_LIGHTING);
        // set up light colors (ambient, diffuse, specular)
        GLfloat lightKa[] = {0.8f, 0.8f, 0.8f, 1.0f};   // ambient light
        ...
        glDisable(GL_LIGHT6);
        glDisable(GL_LIGHT7);
        GLfloat light0Ka[] = {1.0f, 1.0f, 1.0f, 1.0f};   // ambient light
        GLfloat light0Kd[] = {1.0f, 1.0f, 1.0f, 1.0f};   // diffuse light
        GLfloat light0Ks[] = {1.0f, 1.0f, 1.0f, 1.0f};      // specular light
        glLightfv(GL_LIGHT0, GL_AMBIENT, light0Ka);
        glLightfv(GL_LIGHT0, GL_DIFFUSE, light0Kd);
        glLightfv(GL_LIGHT0, GL_SPECULAR, light0Ks);
        // position the light
        GLfloat light0Pos[4] = {-2.0f, 1.0f, 0.0f, 1};
